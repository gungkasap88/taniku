class ResponseKebun {
  ...
  ResponseKebun({this.isSuccess, this.message, this.data1, this.error});

  ResponseKebun.fromJson(Map<String, dynamic> json) {
  ...
  factory ResponseKebun.withError(String error) => ResponseKebun(error: error);
