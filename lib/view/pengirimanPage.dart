                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    TextField(
                                                                      ...
                                                                      decoration: new InputDecoration(
                                                                        hintText: viewModel.getPengiriman[index].tanggalPengiriman.toString().substring(0,10),
                                                                    ...
                                                                    TextField(
                                                                      ...
                                                                      new TextStyle(fontSize: 16.0,),
                                                                      decoration: new InputDecoration(
                                                                        hintText: viewModel.getPengiriman[index].tanggalPengiriman.toString().substring(
                                                                            10, viewModel.getPengiriman[index].tanggalPengiriman.toString().length),
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ElevatedButton(
                                                                          ...
                                                                          onPressed:() async {
                                                                            var dateTanggal = tgl + " " + timeC.text + ':' + '00';
                                                                            viewModel.getDataJadwalUlang(dateTanggal.toString(),
                                                                                viewModel.getPengiriman[index].noReservasi.toString());
                                                                          },
                                                                        )
                                                                      ],
